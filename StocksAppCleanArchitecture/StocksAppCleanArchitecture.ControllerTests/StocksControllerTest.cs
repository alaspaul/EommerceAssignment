...
namespace StockTest
{
 ...
 {
  private readonly IFinnhubServiceStockService _finnhubService;
  private readonly Mock<IFinnhubServiceStockService> _finnhubServiceMock;
  ...
  public StocksControllerTest()
  {
   ...
   _finnhubServiceMock = new Mock<IFinnhubServiceStockService>();
